...
class RemoveImage implements RequestHandlerInterface
{
    ...
    public function __construct(private QueryBus $queryBus, VehicleRepository $vehicleRepository, QuotationRepository $quotationRepository, private GenericRepository $genericRepository, private array $config)
    {
    }
